...
Road traffic data -- vehicular flow and speed -- are needed first. Such data can be downloaded from Caltrans, for instance, or directly using the links provided in the metadata.yml file stored in the data directory.
