...
## Results 
Simulation outcomes for additional data periods and splits for the mixture of two log-normally distributed call durations are available in the results directory. Simulation results for an exponentially distributed call duration setting are included too.
